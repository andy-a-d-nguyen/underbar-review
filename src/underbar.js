(function() {
  ...
  // create obj
  // iterate over array
  // if current element is not found in obj
  // push current elelemnt as key and value to obj
  // iterate over object
  // push value to array
  // return result array
    var result = [];
    ...
    if (!isSorted) {
      ...
      for (var j = 0; j < array.length; j++) {
        if (obj[iterator(array[j])] === undefined) {
          obj[iterator(array[j])] = array[j];
        }
      }
    }
    for (var key in obj) {
  ...
  _.map = function(collection, iterator) {
    ...
    // call iterator on each element in input array
    // push result of call to result array
